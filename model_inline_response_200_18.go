...
func (o *InlineResponse20018) GetData() []map[string]interface{} {
	if o == nil || o.Data == nil {
...
func (o *InlineResponse20018) GetDataOk() (*[]map[string]interface{}, bool) {
	if o == nil || o.Data == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *InlineResponse20018) SetData(v []map[string]interface{}) {
	o.Data = &v
}
